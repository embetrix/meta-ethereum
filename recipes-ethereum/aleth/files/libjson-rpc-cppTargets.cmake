...
set_target_properties(libjson-rpc-cpp::common PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${CMAKE_SYSROOT}/usr/lib/libjsonrpccpp-client.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS libjson-rpc-cpp::common )
list(APPEND _IMPORT_CHECK_FILES_FOR_libjson-rpc-cpp::common "${CMAKE_SYSROOT}/usr/lib/libjsonrpccpp-common.a" )
...
set_target_properties(libjson-rpc-cpp::client PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${CMAKE_SYSROOT}/usr/lib/libjsonrpccpp-common.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS libjson-rpc-cpp::client )
list(APPEND _IMPORT_CHECK_FILES_FOR_libjson-rpc-cpp::client "${CMAKE_SYSROOT}/usr/lib/libjsonrpccpp-client.a" )
...
set_target_properties(libjson-rpc-cpp::server PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${CMAKE_SYSROOT}/usr/lib/libjsonrpccpp-server.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS libjson-rpc-cpp::server )
list(APPEND _IMPORT_CHECK_FILES_FOR_libjson-rpc-cpp::server "${CMAKE_SYSROOT}/usr/lib/libjsonrpccpp-server.a" )
